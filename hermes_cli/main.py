...
def _coalesce_session_name_args(argv: list) -> list:
    ...
    _SUBCOMMANDS = {
        ...
        "sessions", "insights", "update", "uninstall", "profile", "mobile", "dashboard", "serve",
...
def cmd_dashboard(args):
    ...
    from hermes_cli.mobile_startup import mobile_listener_for_serve

    with mobile_listener_for_serve(args):
        start_server(
            host=args.host,
            port=args.port,
...
def _build_cli_parser():
    ...
    from hermes_cli.mobile_cmd import cmd_mobile
