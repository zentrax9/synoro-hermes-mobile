...
export const api = {
  ...
  // ── Admin: Hermes Mobile devices ───────────────────────────────────
  getMobileDevices: () =>
    fetchJSON<{ devices: MobileDeviceRecord[] }>("/api/mobile/devices"),
  revokeMobileDevice: (deviceId: string) =>
    fetchJSON<MobileDeviceRecord>(
...
export interface MobileDeviceRecord {
  ...
  relay_reconciled?: boolean;
  relay_warning?: string;
}
